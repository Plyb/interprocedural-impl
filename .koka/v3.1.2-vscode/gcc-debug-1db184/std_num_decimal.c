// Koka generated module: std/num/decimal, koka version: 3.1.2, platform: 64-bit
...
kk_std_num_decimal__decimal kk_std_num_decimal_decimal_fs__copy(kk_std_num_decimal__decimal _this, kk_std_core_types__optional num, kk_std_core_types__optional exp, kk_context_t* _ctx) { /* (decimal, num : ? int, exp : ? int) -> decimal */ 
  ...
  if (kk_std_core_types__is_Optional(num, _ctx)) {
    ...
    kk_integer_t _uniq_num_108 = kk_integer_unbox(_box_x0, _ctx);
    kk_integer_dup(_uniq_num_108, _ctx);
    kk_std_core_types__optional_drop(num, _ctx);
    _x_x431 = _uniq_num_108; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(num, _ctx);
    {
  ...
  if (kk_std_core_types__is_Optional(exp, _ctx)) {
    ...
    kk_integer_t _uniq_exp_115 = kk_integer_unbox(_box_x1, _ctx);
    kk_integer_dup(_uniq_exp_115, _ctx);
    kk_std_core_types__optional_drop(exp, _ctx);
    kk_std_num_decimal__decimal_drop(_this, _ctx);
    _x_x432 = _uniq_exp_115; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(exp, _ctx);
    {
...
kk_std_num_decimal__decimal kk_std_num_decimal_decimal_exp(kk_integer_t i, kk_std_core_types__optional exp, kk_context_t* _ctx) { /* (i : int, exp : ? int) -> decimal */ 
  ...
  if (kk_std_core_types__is_Optional(exp, _ctx)) {
    ...
    kk_integer_t _uniq_exp_566 = kk_integer_unbox(_box_x2, _ctx);
    kk_integer_dup(_uniq_exp_566, _ctx);
    _brw_x417 = _uniq_exp_566; /*int*/
  }
  else {
  ...
  if (_match_x416) {
    ...
    if (kk_std_core_types__is_Optional(exp, _ctx)) {
      ...
      kk_integer_t _uniq_exp_566_0 = kk_integer_unbox(_box_x3, _ctx);
      kk_integer_dup(_uniq_exp_566_0, _ctx);
      _x_x441 = _uniq_exp_566_0; /*int*/
    }
    else {
  ...
  if (kk_std_core_types__is_Optional(exp, _ctx)) {
    ...
    kk_integer_t _uniq_exp_566_1 = kk_integer_unbox(_box_x4, _ctx);
    kk_integer_dup(_uniq_exp_566_1, _ctx);
    _x_x442 = _uniq_exp_566_1; /*int*/
  }
  else {
  ...
  if (_match_x415) {
    ...
    if (kk_std_core_types__is_Optional(exp, _ctx)) {
      ...
      kk_integer_t _uniq_exp_566_2 = kk_integer_unbox(_box_x5, _ctx);
      kk_integer_dup(_uniq_exp_566_2, _ctx);
      kk_std_core_types__optional_drop(exp, _ctx);
      _x_x444 = _uniq_exp_566_2; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(exp, _ctx);
  ...
  }
  {
    ...
    }
    {
      ...
      if (kk_std_core_types__is_Optional(min_prec, _ctx)) {
        ...
        kk_integer_t _uniq_min_prec_606 = kk_integer_unbox(_box_x12, _ctx);
        kk_integer_dup(_uniq_min_prec_606, _ctx);
        kk_std_core_types__optional_drop(min_prec, _ctx);
        _x_x486 = _uniq_min_prec_606; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(min_prec, _ctx);
...
kk_std_num_decimal__decimal kk_std_num_decimal_int_fs_decimal(kk_integer_t i, kk_std_core_types__optional exp, kk_context_t* _ctx) { /* (i : int, exp : ? int) -> decimal */ 
  ...
  if (kk_std_core_types__is_Optional(exp, _ctx)) {
    ...
    kk_integer_t _uniq_exp_1232 = kk_integer_unbox(_box_x17, _ctx);
    kk_integer_dup(_uniq_exp_1232, _ctx);
    kk_std_core_types__optional_drop(exp, _ctx);
    _x_x510 = _uniq_exp_1232; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(exp, _ctx);
...
kk_std_num_decimal__decimal kk_std_num_decimal_round_to_prec(kk_std_num_decimal__decimal x, kk_std_core_types__optional prec, kk_std_core_types__optional rnd, kk_context_t* _ctx) { /* (x : decimal, prec : ? int, rnd : ? round) -> decimal */ 
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_1297 = kk_integer_unbox(_box_x20, _ctx);
    kk_integer_dup(_uniq_prec_1297, _ctx);
    _x_x518 = _uniq_prec_1297; /*int*/
  }
  else {
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_1297_0 = kk_integer_unbox(_box_x21, _ctx);
      kk_integer_dup(_uniq_prec_1297_0, _ctx);
      _x_x520 = _uniq_prec_1297_0; /*int*/
    }
    else {
      ...
      _match_x363 = kk_std_core_int_divmod_exp10(_x_x521, _x_x522, _ctx); /*(int, int)*/
      {
        ...
        if (_match_x364) {
          ...
          if (kk_std_core_types__is_Optional(rnd, _ctx)) {
            ...
            kk_std_num_decimal__round _uniq_rnd_1301 = kk_std_num_decimal__round_unbox(_box_x24, KK_BORROWED, _ctx);
            kk_std_core_types__optional_drop(rnd, _ctx);
            if (kk_std_num_decimal__is_Half_even(_uniq_rnd_1301, _ctx)) {
            ...
            if (kk_std_num_decimal__is_Half_floor(_uniq_rnd_1301, _ctx)) {
            ...
            if (kk_std_num_decimal__is_Half_ceiling(_uniq_rnd_1301, _ctx)) {
              kk_integer_drop(q, _ctx);
              q1 = kk_function_call(kk_integer_t, (kk_function_t, bool, kk_context_t*), round_half, (round_half, false, _ctx), _ctx); /*int*/
              goto _match_x525;
            }
            if (kk_std_num_decimal__is_Half_truncate(_uniq_rnd_1301, _ctx)) {
              bool _x_x527;
            ...
            if (kk_std_num_decimal__is_Half_away_from_zero(_uniq_rnd_1301, _ctx)) {
              bool _x_x528;
            ...
            if (kk_std_num_decimal__is_Floor(_uniq_rnd_1301, _ctx)) {
              kk_function_drop(round_half, _ctx);
              q1 = q; /*int*/
              goto _match_x525;
            }
            if (kk_std_num_decimal__is_Ceiling(_uniq_rnd_1301, _ctx)) {
              kk_function_drop(round_half, _ctx);
              q1 = kk_integer_add_small_const(q, 1, _ctx); /*int*/
              goto _match_x525;
            }
            if (kk_std_num_decimal__is_Truncate(_uniq_rnd_1301, _ctx)) {
              kk_function_drop(round_half, _ctx);
        ...
        if (kk_std_core_types__is_Optional(prec, _ctx)) {
          ...
          kk_integer_t _uniq_prec_1297_1 = kk_integer_unbox(_box_x25, _ctx);
          kk_integer_dup(_uniq_prec_1297_1, _ctx);
          kk_std_core_types__optional_drop(prec, _ctx);
          _x_x530 = _uniq_prec_1297_1; /*int*/
        }
        else {
          kk_std_core_types__optional_drop(prec, _ctx);
...
kk_std_num_decimal__decimal kk_std_num_decimal_round(kk_std_num_decimal__decimal x, kk_std_core_types__optional rnd, kk_context_t* _ctx) { /* (x : decimal, rnd : ? round) -> decimal */ 
  ...
  if (kk_std_core_types__is_Optional(rnd, _ctx)) {
    ...
    kk_std_num_decimal__round _uniq_rnd_1546 = kk_std_num_decimal__round_unbox(_box_x29, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x535 = _uniq_rnd_1546; /*std/num/decimal/round*/
  }
  else {
    kk_std_core_types__optional_drop(rnd, _ctx);
...
kk_std_num_decimal__decimal kk_std_num_decimal_pow(kk_std_num_decimal__decimal x, kk_integer_t n, kk_context_t* _ctx) { /* (x : decimal, n : int) -> decimal */ 
  ...
  if (_match_x359) {
    ...
    if (kk_std_core_types__is_Optional(_match_x360, _ctx)) {
      ...
      kk_integer_t _uniq_exp_1232 = kk_integer_unbox(_box_x35, _ctx);
      kk_integer_dup(_uniq_exp_1232, _ctx);
      kk_std_core_types__optional_drop(_match_x360, _ctx);
      _b_x36_38 = _uniq_exp_1232; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x360, _ctx);
  ...
  kk_std_core_types__tuple2 _match_x348 = kk_std_num_float64_decode(d, _ctx); /*(int, int)*/;
  {
    ...
    if (_match_x349) {
      ...
      if (kk_std_core_types__is_Optional(_match_x358, _ctx)) {
        ...
        kk_integer_t _uniq_exp_1232 = kk_integer_unbox(_box_x42, _ctx);
        kk_integer_dup(_uniq_exp_1232, _ctx);
        kk_std_core_types__optional_drop(_match_x358, _ctx);
        _x_x550 = _uniq_exp_1232; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x358, _ctx);
    ...
    }
    {
      ...
      if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
        ...
        kk_integer_t _uniq_max_prec_1685 = kk_integer_unbox(_box_x44, _ctx);
        kk_integer_dup(_uniq_max_prec_1685, _ctx);
        _brw_x356 = _uniq_max_prec_1685; /*int*/
      }
      else {
      ...
      if (_match_x352) {
        ...
        if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
          ...
          kk_integer_t _uniq_max_prec_1685_0 = kk_integer_unbox(_box_x45, _ctx);
          kk_integer_dup(_uniq_max_prec_1685_0, _ctx);
          _brw_x354 = _uniq_max_prec_1685_0; /*int*/
        }
        else {
        ...
        if (_match_x353) {
          ...
          if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
            ...
            kk_integer_t _uniq_max_prec_1685_1 = kk_integer_unbox(_box_x46, _ctx);
            kk_integer_dup(_uniq_max_prec_1685_1, _ctx);
            kk_std_core_types__optional_drop(max_prec, _ctx);
            prec = _uniq_max_prec_1685_1; /*int*/
          }
          else {
            kk_std_core_types__optional_drop(max_prec, _ctx);
      ...
      if (kk_std_core_types__is_Optional(_match_x351, _ctx)) {
        ...
        kk_integer_t _uniq_exp_1232_0 = kk_integer_unbox(_box_x47, _ctx);
        kk_integer_dup(_uniq_exp_1232_0, _ctx);
        kk_std_core_types__optional_drop(_match_x351, _ctx);
        _b_x48_53 = _uniq_exp_1232_0; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x351, _ctx);
      ...
      if (kk_std_core_types__is_Optional(_match_x350, _ctx)) {
        ...
        kk_integer_t _uniq_exp_1232_1 = kk_integer_unbox(_box_x49, _ctx);
        kk_integer_dup(_uniq_exp_1232_1, _ctx);
        kk_std_core_types__optional_drop(_match_x350, _ctx);
        _b_x50_54 = _uniq_exp_1232_1; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x350, _ctx);
...
kk_integer_t kk_std_num_decimal_int(kk_std_num_decimal__decimal x, kk_std_core_types__optional rnd, kk_context_t* _ctx) { /* (x : decimal, rnd : ? round) -> int */ 
  ...
  if (kk_std_core_types__is_Optional(rnd, _ctx)) {
    ...
    kk_std_num_decimal__round _uniq_rnd_1810 = kk_std_num_decimal__round_unbox(_box_x57, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x564 = _uniq_rnd_1810; /*std/num/decimal/round*/
  }
  else {
    kk_std_core_types__optional_drop(rnd, _ctx);
...
static kk_box_t kk_std_num_decimal__mlift_pdecimal_10263_fun570(kk_function_t _fself, kk_box_t _b_x65, kk_box_t _b_x66, kk_context_t* _ctx) {
  ...
  if (kk_std_core_types__is_Optional(_match_x336, _ctx)) {
    ...
    bool _uniq_hex_528 = kk_bool_unbox(_box_x61);
    kk_std_core_types__optional_drop(_match_x336, _ctx);
    _x_x573 = _uniq_hex_528; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x336, _ctx);
    _x_x573 = false; /*bool*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10263(kk_string_t frac, bool neg, kk_string_t whole, kk_integer_t exp, kk_context_t* _ctx) { /* (frac : string, neg : bool, whole : string, exp : int) -> std/text/parse/parse decimal */ 
  ...
  kk_box_t _x_x569 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun570(_ctx), kk_string_box(_x_x1_1_10259), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*8647*/
  _x_x1_0_10257 = kk_std_core_types__maybe_unbox(_x_x569, KK_OWNED, _ctx); /*maybe<int>*/
  kk_integer_t _x_x1_10255;
  kk_box_t _x_x574 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun575(_ctx), kk_std_core_types__maybe_box(_x_x1_0_10257, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*8647*/
  _x_x1_10255 = kk_integer_unbox(_x_x574, _ctx); /*int*/
  kk_integer_t y_10253 = kk_std_core_string_count(frac, _ctx); /*int*/;
  ...
  _x_x582 = kk_std_core_types__optional_box(_x_x583, _ctx); /*8646*/
  _x_x577 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun578(_ctx), kk_integer_box(_x_x1_10255, _ctx), _x_x582, _ctx); /*8647*/
  i = kk_std_num_decimal__decimal_unbox(_x_x577, KK_OWNED, _ctx); /*std/num/decimal/decimal*/
  if (neg) {
    kk_box_t _x_x584 = kk_std_core_hnd__open_none1(kk_std_num_decimal__new_mlift_pdecimal_10263_fun585(_ctx), kk_std_num_decimal__decimal_box(i, _ctx), _ctx); /*8580*/
...
static kk_box_t kk_std_num_decimal__mlift_pdecimal_10265_fun591(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x595 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10265_fun596(_ctx), _ctx); /*2978*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10265(bool neg, kk_string_t whole, kk_string_t frac, kk_context_t* _ctx) { /* (neg : bool, whole : string, frac : string) -> std/text/parse/parse decimal */ 
  ...
  kk_box_t _x_x590 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal__new_mlift_pdecimal_10265_fun591(_ctx), kk_std_num_decimal__new_mlift_pdecimal_10265_fun599(_ctx), _ctx); /*1635*/
  x_10270 = kk_integer_unbox(_x_x590, _ctx); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_10270, _ctx);
    kk_box_t _x_x600 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10265_fun601(frac, whole, neg, _ctx), _ctx); /*2978*/
...
static kk_box_t kk_std_num_decimal__mlift_pdecimal_10266_fun604(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_string_t _x_x605;
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x606 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10266_fun607(_ctx), _ctx); /*2978*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10266(bool neg, kk_string_t whole, kk_context_t* _ctx) { /* (neg : bool, whole : string) -> std/text/parse/parse decimal */ 
  kk_string_t x_10274;
  kk_box_t _x_x603 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal__new_mlift_pdecimal_10266_fun604(_ctx), kk_std_num_decimal__new_mlift_pdecimal_10266_fun610(_ctx), _ctx); /*1635*/
  x_10274 = kk_string_unbox(_x_x603); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_10274, _ctx);
    kk_box_t _x_x613 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10266_fun614(whole, neg, _ctx), _ctx); /*2978*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10267(bool neg, kk_context_t* _ctx) { /* (neg : bool) -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x616 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10267_fun617(neg, _ctx), _ctx); /*2978*/
...
static kk_box_t kk_std_num_decimal_pdecimal_fun627(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_string_t _x_x628;
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x629 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun630(_ctx), _ctx); /*2978*/
...
static kk_box_t kk_std_num_decimal_pdecimal_fun640(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x644 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun645(_ctx), _ctx); /*2978*/
...
static kk_box_t kk_std_num_decimal_pdecimal_fun654(kk_function_t _fself, kk_box_t _b_x151, kk_box_t _b_x152, kk_context_t* _ctx) {
  ...
  if (kk_std_core_types__is_Optional(_match_x327, _ctx)) {
    ...
    bool _uniq_hex_528 = kk_bool_unbox(_box_x147);
    kk_std_core_types__optional_drop(_match_x327, _ctx);
    _x_x657 = _uniq_hex_528; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x327, _ctx);
    _x_x657 = false; /*bool*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_pdecimal(kk_context_t* _ctx) { /* () -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x619 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun620(_ctx), _ctx); /*2978*/
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x623 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun624(x_10280, _ctx), _ctx); /*2978*/
      return kk_std_num_decimal__decimal_unbox(_x_x623, KK_OWNED, _ctx);
    }
    {
      kk_string_t x_1_10286;
      kk_box_t _x_x626 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal_new_pdecimal_fun627(_ctx), kk_std_num_decimal_new_pdecimal_fun633(_ctx), _ctx); /*1635*/
      x_1_10286 = kk_string_unbox(_x_x626); /*string*/
      if (kk_yielding(kk_context())) {
        kk_string_drop(x_1_10286, _ctx);
        kk_box_t _x_x636 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun637(x_0_10283, x_10280, _ctx), _ctx); /*2978*/
        return kk_std_num_decimal__decimal_unbox(_x_x636, KK_OWNED, _ctx);
      }
      {
        kk_integer_t x_3_10291;
        kk_box_t _x_x639 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal_new_pdecimal_fun640(_ctx), kk_std_num_decimal_new_pdecimal_fun648(_ctx), _ctx); /*1635*/
        x_3_10291 = kk_integer_unbox(_x_x639, _ctx); /*int*/
        if (kk_yielding(kk_context())) {
          kk_integer_drop(x_3_10291, _ctx);
          kk_box_t _x_x649 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun650(x_0_10283, x_1_10286, x_10280, _ctx), _ctx); /*2978*/
        ...
        }
        {
          ...
          kk_std_core_types__maybe _x_x1_0_10257;
          kk_box_t _x_x653 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun654(_ctx), kk_string_box(_x_x1_1_10259), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*8647*/
          _x_x1_0_10257 = kk_std_core_types__maybe_unbox(_x_x653, KK_OWNED, _ctx); /*maybe<int>*/
          kk_integer_t _x_x1_10255;
          kk_box_t _x_x658 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun659(_ctx), kk_std_core_types__maybe_box(_x_x1_0_10257, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*8647*/
          _x_x1_10255 = kk_integer_unbox(_x_x658, _ctx); /*int*/
          kk_integer_t y_10253 = kk_std_core_string_count(x_1_10286, _ctx); /*int*/;
          ...
          _x_x666 = kk_std_core_types__optional_box(_x_x667, _ctx); /*8646*/
          _x_x661 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun662(_ctx), kk_integer_box(_x_x1_10255, _ctx), _x_x666, _ctx); /*8647*/
          i = kk_std_num_decimal__decimal_unbox(_x_x661, KK_OWNED, _ctx); /*std/num/decimal/decimal*/
          if (x_10280) {
            kk_box_t _x_x668 = kk_std_core_hnd__open_none1(kk_std_num_decimal_new_pdecimal_fun669(_ctx), kk_std_num_decimal__decimal_box(i, _ctx), _ctx); /*8580*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_parse_decimal_10269(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x674 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_parse_decimal_10269_fun675(x, _ctx), _ctx); /*2978*/
...
static kk_box_t kk_std_num_decimal_parse_decimal_fun679(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x681 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_parse_decimal_fun682(_ctx), _ctx); /*2978*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_sum(kk_std_core_types__list ds, kk_context_t* _ctx) { /* (ds : list<decimal>) -> decimal */ 
  ...
  _x_x688 = kk_std_num_decimal__decimal_box(_x_x689, _ctx); /*4188*/
  _x_x687 = kk_std_core_list_foldr(ds, _x_x688, kk_std_num_decimal_new_sum_fun690(_ctx), _ctx); /*4188*/
...
kk_string_t kk_std_num_decimal_show_exp(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_2453 = kk_integer_unbox(_box_x238, _ctx);
    kk_integer_dup(_uniq_prec_2453, _ctx);
    _x_x747 = _uniq_prec_2453; /*int*/
  }
  else {
  ...
  digits = kk_std_core_string_count(_x_x753, _ctx); /*int*/
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_2453_0 = kk_integer_unbox(_box_x241, _ctx);
    kk_integer_dup(_uniq_prec_2453_0, _ctx);
    _brw_x295 = _uniq_prec_2453_0; /*int*/
  }
  else {
  ...
  if (_match_x292) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_2453_1 = kk_integer_unbox(_box_x242, _ctx);
      kk_integer_dup(_uniq_prec_2453_1, _ctx);
      kk_std_core_types__optional_drop(prec, _ctx);
      _brw_x293 = _uniq_prec_2453_1; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(prec, _ctx);
...
kk_string_t kk_std_num_decimal_show_fixed(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_2714 = kk_integer_unbox(_box_x245, _ctx);
    kk_integer_dup(_uniq_prec_2714, _ctx);
    _x_x779 = _uniq_prec_2714; /*int*/
  }
  else {
  ...
  if (_match_x274) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_2714_0 = kk_integer_unbox(_box_x248, _ctx);
      kk_integer_dup(_uniq_prec_2714_0, _ctx);
      _brw_x287 = _uniq_prec_2714_0; /*int*/
    }
    else {
    ...
    if (_match_x286) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_2714_1 = kk_integer_unbox(_box_x249, _ctx);
        kk_integer_dup(_uniq_prec_2714_1, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x788 = _uniq_prec_2714_1; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_2714_2 = kk_integer_unbox(_box_x252, _ctx);
      kk_integer_dup(_uniq_prec_2714_2, _ctx);
      _brw_x279 = _uniq_prec_2714_2; /*int*/
    }
    else {
    ...
    if (_match_x276) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_2714_3 = kk_integer_unbox(_box_x253, _ctx);
        kk_integer_dup(_uniq_prec_2714_3, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _brw_x277 = _uniq_prec_2714_3; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
...
kk_string_t kk_std_num_decimal_show(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (_match_x267) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_2375 = kk_integer_unbox(_box_x256, _ctx);
      kk_integer_dup(_uniq_prec_2375, _ctx);
      _brw_x270 = _uniq_prec_2375; /*int*/
    }
    else {
    ...
    if (_match_x269) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_2375_0 = kk_integer_unbox(_box_x257, _ctx);
        kk_integer_dup(_uniq_prec_2375_0, _ctx);
        _brw_x272 = _uniq_prec_2375_0; /*int*/
      }
      else {
    ...
    if (_match_x268) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_2375_1 = kk_integer_unbox(_box_x258, _ctx);
        kk_integer_dup(_uniq_prec_2375_1, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x822 = _uniq_prec_2375_1; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
    ...
    }
    {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_2375_2 = kk_integer_unbox(_box_x260, _ctx);
        kk_integer_dup(_uniq_prec_2375_2, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x825 = _uniq_prec_2375_2; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_2375_3 = kk_integer_unbox(_box_x262, _ctx);
      kk_integer_dup(_uniq_prec_2375_3, _ctx);
      kk_std_core_types__optional_drop(prec, _ctx);
      _x_x828 = _uniq_prec_2375_3; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(prec, _ctx);
