// Koka generated module: std/time/timestamp, koka version: 3.1.2, platform: 64-bit
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_timestamp_fs__copy(kk_std_time_timestamp__timestamp _this, kk_std_core_types__optional since, kk_std_core_types__optional leap32, kk_context_t* _ctx) { /* (timestamp, since : ? timespan, leap32 : ? int32) -> timestamp */ 
  ...
  if (kk_std_core_types__is_Optional(since, _ctx)) {
    ...
    kk_std_num_ddouble__ddouble _uniq_since_82 = kk_std_num_ddouble__ddouble_unbox(_box_x0, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(since, _ctx);
    _x_x124 = _uniq_since_82; /*std/time/timestamp/timespan*/
  }
  else {
    kk_std_core_types__optional_drop(since, _ctx);
    {
  ...
  if (kk_std_core_types__is_Optional(leap32, _ctx)) {
    ...
    int32_t _uniq_leap32_89 = kk_int32_unbox(_box_x1, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(leap32, _ctx);
    kk_datatype_ptr_dropn(_this, (KK_I32(0)), _ctx);
    _x_x126 = _uniq_leap32_89; /*int32*/
  }
  else {
    kk_std_core_types__optional_drop(leap32, _ctx);
    {
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_timestamp(kk_std_num_ddouble__ddouble t, kk_std_core_types__optional leap_0, kk_context_t* _ctx) { /* (t : timespan, leap : ? int) -> timestamp */ 
  ...
  if (kk_std_core_types__is_Optional(leap_0, _ctx)) {
    kk_box_t _box_x2 = leap_0._cons._Optional.value;
    kk_integer_t _uniq_leap_127 = kk_integer_unbox(_box_x2, _ctx);
    kk_integer_dup(_uniq_leap_127, _ctx);
    kk_std_core_types__optional_drop(leap_0, _ctx);
    _x_x131 = _uniq_leap_127; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(leap_0, _ctx);
    _x_x131 = kk_integer_from_small(0); /*int*/
  }
  _x_x130 = kk_integer_clamp32(_x_x131,kk_context()); /*int32*/
  return kk_std_time_timestamp__new_Timestamp(kk_reuse_null, 0, t, _x_x130, _ctx);
}
...
kk_std_core_types__order kk_std_time_timestamp_cmp(kk_std_time_timestamp__timestamp i, kk_std_time_timestamp__timestamp j, kk_context_t* _ctx) { /* (i : timestamp, j : timestamp) -> order */ 
  ...
  double _x_x132;
  {
    struct kk_std_time_timestamp_Timestamp* _con_x133 = kk_std_time_timestamp__as_Timestamp(i, _ctx);
    kk_std_num_ddouble__ddouble _x_3 = _con_x133->since;
    {
      double _x = _x_3.hi;
      _x_x132 = _x; /*float64*/
    }
  ...
  double _x_x134;
  {
    struct kk_std_time_timestamp_Timestamp* _con_x135 = kk_std_time_timestamp__as_Timestamp(j, _ctx);
    kk_std_num_ddouble__ddouble _x_4 = _con_x135->since;
    {
      double _x_0 = _x_4.hi;
      _x_x134 = _x_0; /*float64*/
    }
  }
  _match_x96 = kk_std_num_float64_cmp(_x_x132, _x_x134, _ctx); /*order*/
  if (kk_std_core_types__is_Eq(_match_x96, _ctx)) {
    double _x_x136;
    {
      struct kk_std_time_timestamp_Timestamp* _con_x137 = kk_std_time_timestamp__as_Timestamp(i, _ctx);
      kk_std_num_ddouble__ddouble _x_3_0 = _con_x137->since;
      {
        double _x_1 = _x_3_0.lo;
        _x_x136 = _x_1; /*float64*/
      }
    }
    double _x_x138;
    {
      struct kk_std_time_timestamp_Timestamp* _con_x139 = kk_std_time_timestamp__as_Timestamp(j, _ctx);
      kk_std_num_ddouble__ddouble _x_4_0 = _con_x139->since;
      {
        double _x_2 = _x_4_0.lo;
        _x_x138 = _x_2; /*float64*/
      }
    }
    _match_x92 = kk_std_num_float64_cmp(_x_x136, _x_x138, _ctx); /*order*/
  }
  else {
  ...
  if (kk_std_core_types__is_Eq(_match_x92, _ctx)) {
    ...
    int32_t _x_x140;
    {
      struct kk_std_time_timestamp_Timestamp* _con_x141 = kk_std_time_timestamp__as_Timestamp(i, _ctx);
      kk_std_num_ddouble__ddouble _pat_0_6 = _con_x141->since;
      int32_t _x_5 = _con_x141->leap32;
    ...
    x_0_10008 = kk_integer_from_int(_x_x140,kk_context()); /*int*/
    kk_integer_t y_0_10009;
    int32_t _x_x142;
    {
      struct kk_std_time_timestamp_Timestamp* _con_x143 = kk_std_time_timestamp__as_Timestamp(j, _ctx);
      kk_std_num_ddouble__ddouble _pat_0_7 = _con_x143->since;
      int32_t _x_6 = _con_x143->leap32;
    ...
    y_0_10009 = kk_integer_from_int(_x_x142,kk_context()); /*int*/
  ...
  {
    kk_datatype_ptr_dropn(j, (KK_I32(0)), _ctx);
    kk_datatype_ptr_dropn(i, (KK_I32(0)), _ctx);
    return _match_x92;
  }
}
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp__lp__plus__rp_(kk_std_time_timestamp__timestamp ts, kk_std_num_ddouble__ddouble t, kk_context_t* _ctx) { /* (ts : timestamp, t : timespan) -> timestamp */ 
  kk_std_num_ddouble__ddouble _x_x150;
  kk_std_num_ddouble__ddouble _x_x151;
  {
    ...
    kk_std_num_ddouble__ddouble _x = _con_x152->since;
    _x_x151 = _x; /*std/time/timestamp/timespan*/
  }
  _x_x150 = kk_std_num_ddouble__lp__plus__rp_(_x_x151, t, _ctx); /*std/num/ddouble/ddouble*/
  int32_t _x_x153;
  {
    struct kk_std_time_timestamp_Timestamp* _con_x154 = kk_std_time_timestamp__as_Timestamp(ts, _ctx);
    kk_std_num_ddouble__ddouble _pat_0_0 = _con_x154->since;
    int32_t _x_0 = _con_x154->leap32;
  ...
  return kk_std_time_timestamp__new_Timestamp(kk_reuse_null, 0, _x_x150, _x_x153, _ctx);
}
...
kk_std_num_ddouble__ddouble kk_std_time_timestamp_int_fs_timespan(kk_integer_t seconds, kk_std_core_types__optional frac, kk_context_t* _ctx) { /* (seconds : int, frac : ? float64) -> timespan */ 
  ...
  if (kk_std_core_types__is_Optional(frac, _ctx)) {
    ...
    double _uniq_frac_618 = kk_double_unbox(_box_x3, KK_BORROWED, _ctx);
    _x_x155 = _uniq_frac_618; /*float64*/
  }
  else {
    _x_x155 = 0x0p+0; /*float64*/
  }
  _match_x91 = (_x_x155 == (0x0p+0)); /*bool*/
  if (_match_x91) {
    kk_std_core_types__optional_drop(frac, _ctx);
    return kk_std_num_ddouble_ddouble_int_exp(seconds, kk_integer_from_small(0), _ctx);
  }
  {
    kk_std_num_ddouble__ddouble _x_x156 = kk_std_num_ddouble_ddouble_int_exp(seconds, kk_integer_from_small(0), _ctx); /*std/num/ddouble/ddouble*/
    kk_std_num_ddouble__ddouble _x_x157;
    double _x_x158;
    if (kk_std_core_types__is_Optional(frac, _ctx)) {
      kk_box_t _box_x4 = frac._cons._Optional.value;
      double _uniq_frac_618_0 = kk_double_unbox(_box_x4, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(frac, _ctx);
      _x_x158 = _uniq_frac_618_0; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(frac, _ctx);
      _x_x158 = 0x0p+0; /*float64*/
    }
    _x_x157 = kk_std_num_ddouble__new_Ddouble(_x_x158, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
    return kk_std_num_ddouble__lp__plus__rp_(_x_x156, _x_x157, _ctx);
  }
}
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_int_fs_timestamp(kk_integer_t t, kk_std_core_types__optional frac, kk_std_core_types__optional leap_0, kk_context_t* _ctx) { /* (t : int, frac : ? float64, leap : ? int) -> timestamp */ 
  ...
  if (kk_std_core_types__is_Optional(frac, _ctx)) {
    ...
    double _uniq_frac_682 = kk_double_unbox(_box_x7, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(frac, _ctx);
    _x_x165 = _uniq_frac_682; /*float64*/
  }
  else {
    kk_std_core_types__optional_drop(frac, _ctx);
  ...
  if (kk_std_core_types__is_Optional(leap_0, _ctx)) {
    ...
    kk_integer_t _uniq_leap_686 = kk_integer_unbox(_box_x8, _ctx);
    kk_integer_dup(_uniq_leap_686, _ctx);
    kk_std_core_types__optional_drop(leap_0, _ctx);
    _x_x167 = _uniq_leap_686; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(leap_0, _ctx);
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_timestamp_days(kk_integer_t days_0, kk_std_core_types__optional secs, kk_std_core_types__optional leap_0, kk_context_t* _ctx) { /* (days : int, secs : ? timespan, leap : ? int) -> timestamp */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x86, _ctx)) {
    ...
    double _uniq_frac_618 = kk_double_unbox(_box_x9, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(_match_x86, _ctx);
    _x_x169 = _uniq_frac_618; /*float64*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x86, _ctx);
  ...
  if (_match_x84) {
    ...
    if (kk_std_core_types__is_Optional(_match_x85, _ctx)) {
      ...
      double _uniq_frac_618_0 = kk_double_unbox(_box_x10, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(_match_x85, _ctx);
      _x_x172 = _uniq_frac_618_0; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x85, _ctx);
  ...
  if (kk_std_core_types__is_Optional(secs, _ctx)) {
    ...
    kk_std_num_ddouble__ddouble _uniq_secs_717 = kk_std_num_ddouble__ddouble_unbox(_box_x11, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(secs, _ctx);
    _x_x173 = _uniq_secs_717; /*std/time/timestamp/timespan*/
  }
  else {
    kk_std_core_types__optional_drop(secs, _ctx);
  ...
  if (kk_std_core_types__is_Optional(leap_0, _ctx)) {
    ...
    kk_integer_t _uniq_leap_721 = kk_integer_unbox(_box_x12, _ctx);
    kk_integer_dup(_uniq_leap_721, _ctx);
    kk_std_core_types__optional_drop(leap_0, _ctx);
    _x_x175 = _uniq_leap_721; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(leap_0, _ctx);
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_add_days(kk_std_time_timestamp__timestamp ts, kk_integer_t days_0, kk_context_t* _ctx) { /* (ts : timestamp, days : int) -> timestamp */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x83, _ctx)) {
    ...
    double _uniq_frac_618 = kk_double_unbox(_box_x13, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(_match_x83, _ctx);
    _x_x176 = _uniq_frac_618; /*float64*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x83, _ctx);
  ...
  if (_match_x81) {
    ...
    if (kk_std_core_types__is_Optional(_match_x82, _ctx)) {
      ...
      double _uniq_frac_618_0 = kk_double_unbox(_box_x14, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(_match_x82, _ctx);
      _x_x179 = _uniq_frac_618_0; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x82, _ctx);
...
kk_std_num_ddouble__ddouble kk_std_time_timestamp_unsafe_timespan_withleap(kk_std_time_timestamp__timestamp ts, kk_context_t* _ctx) { /* (ts : timestamp) -> timespan */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x78, _ctx)) {
    ...
    double _uniq_frac_618 = kk_double_unbox(_box_x31, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(_match_x78, _ctx);
    _x_x220 = _uniq_frac_618; /*float64*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x78, _ctx);
  ...
  if (_match_x76) {
    ...
    if (kk_std_core_types__is_Optional(_match_x77, _ctx)) {
      ...
      double _uniq_frac_618_0 = kk_double_unbox(_box_x32, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(_match_x77, _ctx);
      _x_x223 = _uniq_frac_618_0; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x77, _ctx);
...
kk_std_time_timestamp__timestamp kk_std_time_timestamp_add_leap_seconds(kk_std_time_timestamp__timestamp ts, kk_std_num_ddouble__ddouble leaps, kk_context_t* _ctx) { /* (ts : timestamp, leaps : timespan) -> timestamp */ 
  ...
  if (b_10054) {
    ...
    if (kk_std_core_types__is_Optional(_match_x75, _ctx)) {
      ...
      double _uniq_frac_618 = kk_double_unbox(_box_x33, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(_match_x75, _ctx);
      _x_x231 = _uniq_frac_618; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x75, _ctx);
    ...
    if (_match_x73) {
      ...
      if (kk_std_core_types__is_Optional(_match_x74, _ctx)) {
        ...
        double _uniq_frac_618_0 = kk_double_unbox(_box_x34, KK_BORROWED, _ctx);
        kk_std_core_types__optional_drop(_match_x74, _ctx);
        _x_x234 = _uniq_frac_618_0; /*float64*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x74, _ctx);
    ...
    if (_match_x63) {
      ...
      if (_match_x65) {
        ...
        if (kk_std_core_types__is_Optional(_match_x69, _ctx)) {
          ...
          double _uniq_frac_618_0_0 = kk_double_unbox(_box_x35, KK_BORROWED, _ctx);
          kk_std_core_types__optional_drop(_match_x69, _ctx);
          _x_x242 = _uniq_frac_618_0_0; /*float64*/
        }
        else {
          kk_std_core_types__optional_drop(_match_x69, _ctx);
        ...
        if (_match_x67) {
          ...
          if (kk_std_core_types__is_Optional(_match_x68, _ctx)) {
            ...
            double _uniq_frac_618_0_1 = kk_double_unbox(_box_x36, KK_BORROWED, _ctx);
            kk_std_core_types__optional_drop(_match_x68, _ctx);
            _x_x245 = _uniq_frac_618_0_1; /*float64*/
          }
          else {
            kk_std_core_types__optional_drop(_match_x68, _ctx);
...
kk_string_t kk_std_time_timestamp_ts_show(kk_std_time_timestamp__timestamp ts, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_std_core_types__optional unit, kk_context_t* _ctx) { /* (ts : timestamp, max-prec : ? int, secs-width : ? int, unit : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
    ...
    kk_integer_t _uniq_max_prec_1197 = kk_integer_unbox(_box_x37, _ctx);
    kk_integer_dup(_uniq_max_prec_1197, _ctx);
    kk_std_core_types__optional_drop(max_prec, _ctx);
    _b_x38_43 = _uniq_max_prec_1197; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(max_prec, _ctx);
  ...
  if (kk_std_core_types__is_Optional(secs_width, _ctx)) {
    ...
    kk_integer_t _uniq_secs_width_1201 = kk_integer_unbox(_box_x39, _ctx);
    kk_integer_dup(_uniq_secs_width_1201, _ctx);
    kk_std_core_types__optional_drop(secs_width, _ctx);
    _b_x40_44 = _uniq_secs_width_1201; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(secs_width, _ctx);
  ...
  if (kk_std_core_types__is_Optional(unit, _ctx)) {
    ...
    kk_string_t _uniq_unit_1205 = kk_string_unbox(_box_x41);
    kk_string_dup(_uniq_unit_1205, _ctx);
    kk_std_core_types__optional_drop(unit, _ctx);
    _b_x42_45 = _uniq_unit_1205; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(unit, _ctx);
  ...
  kk_std_core_types__optional _x_x299 = kk_std_core_types__new_Optional(kk_integer_box(_b_x38_43, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x300 = kk_std_core_types__new_Optional(kk_integer_box(_b_x40_44, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x301 = kk_std_core_types__new_Optional(kk_string_box(_b_x42_45), _ctx); /*? 7*/
...
kk_string_t kk_std_time_timestamp_ts_show_days(kk_std_time_timestamp__timestamp ts, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (ts : timestamp, prec : ? int) -> string */ 
  ...
  _match_x56 = kk_std_time_timestamp_days_seconds(_x_x302, _ctx); /*(int, std/num/ddouble/ddouble)*/
  {
    ...
    kk_std_time_timestamp__timestamp _arg_x1426;
    int32_t _x_x305;
    kk_integer_t _x_x306;
    kk_std_core_types__optional _match_x57 = kk_std_core_types__new_Optional(kk_integer_box(_b_x48_49, _ctx), _ctx); /*? 7*/;
    if (kk_std_core_types__is_Optional(_match_x57, _ctx)) {
      kk_box_t _box_x50 = _match_x57._cons._Optional.value;
      kk_integer_t _uniq_leap_127 = kk_integer_unbox(_box_x50, _ctx);
      kk_integer_dup(_uniq_leap_127, _ctx);
      kk_std_core_types__optional_drop(_match_x57, _ctx);
      _x_x306 = _uniq_leap_127; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x57, _ctx);
    ...
    _arg_x1426 = kk_std_time_timestamp__new_Timestamp(kk_reuse_null, 0, secs, _x_x305, _ctx); /*std/time/timestamp/timestamp*/
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_1324 = kk_integer_unbox(_box_x51, _ctx);
      kk_integer_dup(_uniq_prec_1324, _ctx);
      kk_std_core_types__optional_drop(prec, _ctx);
      _b_x52_54 = _uniq_prec_1324; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(prec, _ctx);
    ...
    kk_string_t _x_x312;
    kk_std_core_types__optional _x_x313 = kk_std_core_types__new_Optional(kk_integer_box(_b_x52_54, _ctx), _ctx); /*? 7*/
    kk_std_core_types__optional _x_x314 = kk_std_core_types__new_Optional(kk_string_box(_b_x53_55), _ctx); /*? 7*/
    _x_x312 = kk_std_time_timestamp_ts_show(_arg_x1426, _x_x313, kk_std_core_types__new_None(_ctx), _x_x314, _ctx); /*string*/
...
void kk_std_time_timestamp__init(kk_context_t* _ctx){
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(_match_x89, _ctx)) {
      kk_box_t _box_x5 = _match_x89._cons._Optional.value;
      double _uniq_frac_618 = kk_double_unbox(_box_x5, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(_match_x89, _ctx);
      _x_x159 = _uniq_frac_618; /*float64*/
    }
    else {
      kk_std_core_types__optional_drop(_match_x89, _ctx);
      _x_x159 = 0x0p+0; /*float64*/
    }
    _match_x87 = (_x_x159 == (0x0p+0)); /*bool*/
    if (_match_x87) {
      ...
      kk_std_num_ddouble__ddouble _x_x160 = kk_std_num_ddouble_ddouble_int_exp(kk_integer_from_int(86400, _ctx), kk_integer_from_small(0), _ctx); /*std/num/ddouble/ddouble*/
      kk_std_num_ddouble__ddouble _x_x161;
      double _x_x162;
      ...
      if (kk_std_core_types__is_Optional(_match_x88, _ctx)) {
        kk_box_t _box_x6 = _match_x88._cons._Optional.value;
        double _uniq_frac_618_0 = kk_double_unbox(_box_x6, KK_BORROWED, _ctx);
        kk_std_core_types__optional_drop(_match_x88, _ctx);
        _x_x162 = _uniq_frac_618_0; /*float64*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x88, _ctx);
        _x_x162 = 0x0p+0; /*float64*/
      }
      _x_x161 = kk_std_num_ddouble__new_Ddouble(_x_x162, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
      kk_std_time_timestamp_solar_secs_per_day = kk_std_num_ddouble__lp__plus__rp_(_x_x160, _x_x161, _ctx); /*std/time/timestamp/timespan*/
    }
  }
  {
