...
static inline kk_std_time_timestamp__timestamp kk_std_time_utc_leap_adjust_fs_utc_start(kk_std_time_utc__leap_adjust _this, kk_context_t* _ctx) { /* (leap-adjust) -> utc-timestamp */ 
  {
    struct kk_std_time_utc_Leap_adjust* _con_x1182 = kk_std_time_utc__as_Leap_adjust(_this, _ctx);
    kk_std_time_timestamp__timestamp _x = _con_x1182->utc_start;
    kk_std_num_ddouble__ddouble _pat_2 = _con_x1182->offset;
    kk_std_time_timestamp__timestamp _pat_5 = _con_x1182->drift_start;
    kk_std_num_ddouble__ddouble _pat_8 = _con_x1182->drift;
    struct kk_std_time_timestamp_Timestamp* _con_x1183 = kk_std_time_timestamp__as_Timestamp(_x, _ctx);
    struct kk_std_time_timestamp_Timestamp* _con_x1184 = kk_std_time_timestamp__as_Timestamp(_pat_5, _ctx);
...
static inline kk_std_num_ddouble__ddouble kk_std_time_utc_leap_adjust_fs_offset(kk_std_time_utc__leap_adjust _this, kk_context_t* _ctx) { /* (leap-adjust) -> std/time/timestamp/timespan */ 
  {
    struct kk_std_time_utc_Leap_adjust* _con_x1185 = kk_std_time_utc__as_Leap_adjust(_this, _ctx);
    kk_std_time_timestamp__timestamp _pat_0 = _con_x1185->utc_start;
    kk_std_num_ddouble__ddouble _x = _con_x1185->offset;
    kk_std_time_timestamp__timestamp _pat_5 = _con_x1185->drift_start;
    kk_std_num_ddouble__ddouble _pat_8 = _con_x1185->drift;
    struct kk_std_time_timestamp_Timestamp* _con_x1186 = kk_std_time_timestamp__as_Timestamp(_pat_0, _ctx);
    struct kk_std_time_timestamp_Timestamp* _con_x1187 = kk_std_time_timestamp__as_Timestamp(_pat_5, _ctx);
    return _x;
  }
}
...
static inline kk_std_time_timestamp__timestamp kk_std_time_utc_leap_adjust_fs_drift_start(kk_std_time_utc__leap_adjust _this, kk_context_t* _ctx) { /* (leap-adjust) -> utc-timestamp */ 
  {
    struct kk_std_time_utc_Leap_adjust* _con_x1188 = kk_std_time_utc__as_Leap_adjust(_this, _ctx);
    kk_std_time_timestamp__timestamp _pat_0 = _con_x1188->utc_start;
    kk_std_num_ddouble__ddouble _pat_3 = _con_x1188->offset;
    kk_std_time_timestamp__timestamp _x = _con_x1188->drift_start;
    kk_std_num_ddouble__ddouble _pat_8 = _con_x1188->drift;
    struct kk_std_time_timestamp_Timestamp* _con_x1189 = kk_std_time_timestamp__as_Timestamp(_pat_0, _ctx);
    struct kk_std_time_timestamp_Timestamp* _con_x1190 = kk_std_time_timestamp__as_Timestamp(_x, _ctx);
    return kk_std_time_timestamp__timestamp_dup(_x, _ctx);
  }
}
...
static inline kk_std_num_ddouble__ddouble kk_std_time_utc_leap_adjust_fs_drift(kk_std_time_utc__leap_adjust _this, kk_context_t* _ctx) { /* (leap-adjust) -> std/num/ddouble/ddouble */ 
  {
    struct kk_std_time_utc_Leap_adjust* _con_x1191 = kk_std_time_utc__as_Leap_adjust(_this, _ctx);
    kk_std_time_timestamp__timestamp _pat_0 = _con_x1191->utc_start;
    kk_std_num_ddouble__ddouble _pat_3 = _con_x1191->offset;
    kk_std_time_timestamp__timestamp _pat_6 = _con_x1191->drift_start;
    kk_std_num_ddouble__ddouble _x = _con_x1191->drift;
    struct kk_std_time_timestamp_Timestamp* _con_x1192 = kk_std_time_timestamp__as_Timestamp(_pat_0, _ctx);
    struct kk_std_time_timestamp_Timestamp* _con_x1193 = kk_std_time_timestamp__as_Timestamp(_pat_6, _ctx);
    return _x;
  }
}
...
static inline kk_std_time_instant__instant kk_std_time_utc_leaps_table_fs_expire(kk_std_time_utc__leaps_table _this, kk_context_t* _ctx) { /* (leaps-table) -> std/time/instant/instant */ 
  {
    struct kk_std_time_utc_Leaps_table* _con_x1210 = kk_std_time_utc__as_Leaps_table(_this, _ctx);
    kk_std_time_instant__instant _x = _con_x1210->expire;
...
static inline kk_std_core_types__list kk_std_time_utc_leaps_table_fs_adjusts(kk_std_time_utc__leaps_table _this, kk_context_t* _ctx) { /* (leaps-table) -> list<leap-adjust> */ 
  {
    struct kk_std_time_utc_Leaps_table* _con_x1211 = kk_std_time_utc__as_Leaps_table(_this, _ctx);
    kk_std_time_instant__instant _pat_0 = _con_x1211->expire;
    kk_std_core_types__list _x = _con_x1211->adjusts;
...
static inline kk_integer_t kk_std_time_utc_utc_fs__cfc(kk_std_time_utc__utc utc_0, kk_context_t* _ctx) { /* forall<e,a> (utc : utc<e,a>) -> int */ 
  {
    struct kk_std_time_utc__Hnd_utc* _con_x1216 = kk_std_time_utc__as_Hnd_utc(utc_0, _ctx);
    kk_integer_t _x = _con_x1216->_cfc;
...
static inline kk_std_core_hnd__clause0 kk_std_time_utc_utc_fs__fun_utc(kk_std_time_utc__utc utc_0, kk_context_t* _ctx) { /* forall<e,a> (utc : utc<e,a>) -> hnd/clause0<std/time/instant/timescale,utc,e,a> */ 
  {
    struct kk_std_time_utc__Hnd_utc* _con_x1217 = kk_std_time_utc__as_Hnd_utc(utc_0, _ctx);
    kk_std_core_hnd__clause0 _x = _con_x1217->_fun_utc;
...
static inline kk_std_core_hnd__clause0 kk_std_time_utc__select_utc(kk_std_time_utc__utc hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : utc<e,a>) -> hnd/clause0<std/time/instant/timescale,utc,e,a> */ 
  {
    struct kk_std_time_utc__Hnd_utc* _con_x1218 = kk_std_time_utc__as_Hnd_utc(hnd, _ctx);
    kk_std_core_hnd__clause0 _fun_utc = _con_x1218->_fun_utc;
...
static inline kk_std_time_instant__timescale kk_std_time_utc_utc(kk_context_t* _ctx) { /* () -> utc std/time/instant/timescale */ 
  ...
  kk_box_t _x_x1219;
  {
    struct kk_std_core_hnd_Ev* _con_x1220 = kk_std_core_hnd__as_Ev(ev_10345, _ctx);
    kk_box_t _box_x6 = _con_x1220->hnd;
    int32_t m = _con_x1220->marker;
    kk_std_time_utc__utc h = kk_std_time_utc__utc_unbox(_box_x6, KK_BORROWED, _ctx);
    kk_std_time_utc__utc_dup(h, _ctx);
    {
      struct kk_std_time_utc__Hnd_utc* _con_x1221 = kk_std_time_utc__as_Hnd_utc(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x1221->_cfc;
      kk_std_core_hnd__clause0 _fun_utc = _con_x1221->_fun_utc;
      ...
      {
        kk_function_t _fun_unbox_x9 = _fun_utc.clause;
        _x_x1219 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x9, (_fun_unbox_x9, m, ev_10345, _ctx), _ctx); /*35*/
      }
    }
  }
  return kk_std_time_instant__timescale_unbox(_x_x1219, KK_OWNED, _ctx);
}

extern kk_std_core_hnd__htag kk_std_time_utc__tag_utc;
...
static inline kk_std_time_utc__leap_adjust kk_std_time_utc__create_Leap_adjust(kk_std_time_timestamp__timestamp utc_start, kk_std_num_ddouble__ddouble offset, kk_std_core_types__optional drift_start, kk_std_core_types__optional drift, kk_context_t* _ctx) { /* (utc-start : utc-timestamp, offset : std/time/timestamp/timespan, drift-start : ? utc-timestamp, drift : ? std/num/ddouble/ddouble) -> leap-adjust */ 
  ...
  if (kk_std_core_types__is_Optional(drift_start, _ctx)) {
    ...
    kk_std_time_timestamp__timestamp _uniq_drift_start_441 = kk_std_time_timestamp__timestamp_unbox(_box_x20, KK_BORROWED, _ctx);
    kk_std_time_timestamp__timestamp_dup(_uniq_drift_start_441, _ctx);
    kk_std_core_types__optional_drop(drift_start, _ctx);
    _x_x1225 = _uniq_drift_start_441; /*std/time/utc/utc-timestamp*/
  }
  else {
    kk_std_core_types__optional_drop(drift_start, _ctx);
    _x_x1225 = kk_std_time_timestamp__timestamp_dup(kk_std_time_timestamp_timestamp0, _ctx); /*std/time/utc/utc-timestamp*/
  }
  ...
  if (kk_std_core_types__is_Optional(drift, _ctx)) {
    ...
    kk_std_num_ddouble__ddouble _uniq_drift_445 = kk_std_num_ddouble__ddouble_unbox(_box_x21, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(drift, _ctx);
    _x_x1226 = _uniq_drift_445; /*std/num/ddouble/ddouble*/
  }
  else {
    kk_std_core_types__optional_drop(drift, _ctx);
    _x_x1226 = kk_std_num_ddouble_zero; /*std/num/ddouble/ddouble*/
  }
  return kk_std_time_utc__new_Leap_adjust(kk_reuse_null, 0, utc_start, offset, _x_x1225, _x_x1226, _ctx);
}
...
static inline kk_std_time_instant__timescale kk_std_time_utc_ts_utc_create(kk_std_time_utc__leaps_table leaps, kk_context_t* _ctx) { /* (leaps : leaps-table) -> std/time/instant/timescale */ 
  ...
  kk_define_string_literal(, _s_x2167, 3, "UTC", _ctx)
  _x_x2166 = kk_string_dup(_s_x2167, _ctx); /*string*/
  return kk_std_time_utc_utc_timescale(_x_x2166, leaps, _ctx);
}
...
static inline kk_std_time_instant__timescale kk_std_time_utc_ts_unix_create(kk_std_time_utc__leaps_table leaps, kk_context_t* _ctx) { /* (leaps : leaps-table) -> std/time/instant/timescale */ 
  kk_string_t _x_x2168;
  kk_define_string_literal(, _s_x2169, 3, "UTC", _ctx)
  _x_x2168 = kk_string_dup(_s_x2169, _ctx); /*string*/
  return kk_std_time_utc_utc_timescale(_x_x2168, leaps, _ctx);
}
...
static inline kk_std_time_instant__timescale kk_std_time_utc_ts_ntp_create(kk_std_time_utc__leaps_table leaps, kk_context_t* _ctx) { /* (leaps : leaps-table) -> std/time/instant/timescale */ 
  ...
  kk_define_string_literal(, _s_x2171, 3, "UTC", _ctx)
  _x_x2170 = kk_string_dup(_s_x2171, _ctx); /*string*/
  return kk_std_time_utc_utc_timescale(_x_x2170, leaps, _ctx);
}
