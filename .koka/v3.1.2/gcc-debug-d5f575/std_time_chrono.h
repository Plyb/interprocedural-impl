...
static inline kk_std_time_duration__duration kk_std_time_chrono_now_resolution(kk_context_t* _ctx) { /* () -> ndet std/time/duration/duration */ 
  ...
  kk_std_num_ddouble__ddouble _x_x57 = kk_std_num_ddouble__new_Ddouble(secs_10002, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_time_duration__new_Duration(_x_x57, _ctx);
}
