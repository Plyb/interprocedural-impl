...
static inline kk_integer_t kk_std_time_date_clock_fs_hours(kk_std_time_date__clock clock, kk_context_t* _ctx) { /* (clock : clock) -> int */ 
  {
    struct kk_std_time_date_Clock* _con_x172 = kk_std_time_date__as_Clock(clock, _ctx);
    kk_std_num_ddouble__ddouble _pat_1 = _con_x172->seconds;
    kk_integer_t _x = _con_x172->hours;
...
static inline kk_integer_t kk_std_time_date_clock_fs_minutes(kk_std_time_date__clock clock, kk_context_t* _ctx) { /* (clock : clock) -> int */ 
  {
    struct kk_std_time_date_Clock* _con_x173 = kk_std_time_date__as_Clock(clock, _ctx);
    kk_std_num_ddouble__ddouble _pat_1 = _con_x173->seconds;
    kk_integer_t _x = _con_x173->minutes;
    return kk_integer_dup(_x, _ctx);
  }
}
...
static inline kk_std_num_ddouble__ddouble kk_std_time_date_clock_fs_seconds(kk_std_time_date__clock clock, kk_context_t* _ctx) { /* (clock : clock) -> std/num/ddouble/ddouble */ 
  {
    struct kk_std_time_date_Clock* _con_x174 = kk_std_time_date__as_Clock(clock, _ctx);
    kk_std_num_ddouble__ddouble _x = _con_x174->seconds;
    return _x;
  }
}
...
static inline kk_std_time_date__date kk_std_time_date_weekdate(kk_integer_t year, kk_integer_t month, kk_std_time_date__weekday weekday_0, kk_context_t* _ctx) { /* (year : int, month : int, weekday : weekday) -> date */ 
  kk_integer_t _x_x184 = kk_std_time_date_int(weekday_0, _ctx); /*int*/
  return kk_std_time_date__new_Date(year, month, _x_x184, _ctx);
}
...
static inline bool kk_std_time_date__lp__eq__eq__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  kk_std_core_types__order _x_x194 = kk_std_time_date_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x194, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline kk_std_core_types__order kk_std_time_date_clock_fs_cmp(kk_std_time_date__clock c, kk_std_time_date__clock d, kk_context_t* _ctx) { /* (c : clock, d : clock) -> order */ 
  kk_std_num_ddouble__ddouble x_10048 = kk_std_time_date_total_seconds(c, _ctx); /*std/num/ddouble/ddouble*/;
  kk_std_num_ddouble__ddouble y_10049 = kk_std_time_date_total_seconds(d, _ctx); /*std/num/ddouble/ddouble*/;
  kk_std_core_types__order _match_x126;
  double _x_x219;
  {
    double _x = x_10048.hi;
    _x_x219 = _x; /*float64*/
  }
  double _x_x220;
  {
    double _x_0 = y_10049.hi;
    _x_x220 = _x_0; /*float64*/
  }
  _match_x126 = kk_std_num_float64_cmp(_x_x219, _x_x220, _ctx); /*order*/
  if (kk_std_core_types__is_Eq(_match_x126, _ctx)) {
    double _x_x221;
    {
      double _x_1 = x_10048.lo;
      _x_x221 = _x_1; /*float64*/
    }
    double _x_x222;
    {
      double _x_2 = y_10049.lo;
      _x_x222 = _x_2; /*float64*/
    }
    return kk_std_num_float64_cmp(_x_x221, _x_x222, _ctx);
  }
  {
    return _match_x126;
  }
...
static inline bool kk_std_time_date_clock_fs__lp__eq__eq__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x223 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x223, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline kk_std_time_date__weekday kk_std_time_date_weekday_fs__lp__plus__rp_(kk_std_time_date__weekday wd, kk_integer_t n, kk_context_t* _ctx) { /* (wd : weekday, n : int) -> weekday */ 
  kk_integer_t x_10050 = kk_std_time_date_int(wd, _ctx); /*int*/;
  kk_integer_t _x_x224 = kk_integer_add(x_10050,n,kk_context()); /*int*/
  return kk_std_time_date_weekday(_x_x224, _ctx);
}
...
static inline kk_integer_t kk_std_time_date_weekday_fs__lp__dash__rp_(kk_std_time_date__weekday wd1, kk_std_time_date__weekday wd2, kk_context_t* _ctx) { /* (wd1 : weekday, wd2 : weekday) -> int */ 
  kk_integer_t x_10052 = kk_std_time_date_int(wd1, _ctx); /*int*/;
  kk_integer_t y_10053 = kk_std_time_date_int(wd2, _ctx); /*int*/;
  kk_integer_t _x_x225 = kk_integer_sub(x_10052,y_10053,kk_context()); /*int*/
  return kk_integer_mod(_x_x225,(kk_integer_from_small(7)),kk_context());
}
...
static inline kk_std_time_date__weekday kk_std_time_date_weekdayint_fs__lp__dash__rp_(kk_std_time_date__weekday wd, kk_integer_t n, kk_context_t* _ctx) { /* (wd : weekday, n : int) -> weekday */ 
  kk_integer_t x_10054 = kk_std_time_date_int(wd, _ctx); /*int*/;
  kk_integer_t _x_x226 = kk_integer_sub(x_10054,n,kk_context()); /*int*/
  return kk_std_time_date_weekday(_x_x226, _ctx);
}
...
static inline bool kk_std_time_date_weekday_fs__lp__eq__eq__rp_(kk_std_time_date__weekday i, kk_std_time_date__weekday j, kk_context_t* _ctx) { /* (i : weekday, j : weekday) -> bool */ 
  kk_std_core_types__order _x_x227 = kk_std_time_date_weekday_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x227, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline bool kk_std_time_date__lp__lt__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  ...
  return kk_std_core_order__lp__eq__eq__rp_(_x_x228, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date__lp__excl__eq__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  kk_std_core_types__order _x_x229 = kk_std_time_date_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x229, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_clock_fs__lp__excl__eq__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x230 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x230, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_weekday_fs__lp__excl__eq__rp_(kk_std_time_date__weekday i, kk_std_time_date__weekday j, kk_context_t* _ctx) { /* (i : weekday, j : weekday) -> bool */ 
  kk_std_core_types__order _x_x231 = kk_std_time_date_weekday_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x231, kk_std_core_types__new_Eq(_ctx), _ctx);
}
...
static inline bool kk_std_time_date__lp__lt__eq__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  kk_std_core_types__order _x_x232 = kk_std_time_date_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x232, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date__lp__gt__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  kk_std_core_types__order _x_x233 = kk_std_time_date_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x233, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date__lp__gt__eq__rp_(kk_std_time_date__date i, kk_std_time_date__date j, kk_context_t* _ctx) { /* (i : date, j : date) -> bool */ 
  kk_std_core_types__order _x_x234 = kk_std_time_date_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x234, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_clock_fs__lp__gt__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x278 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x278, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_weekday_fs__lp__gt__rp_(kk_std_time_date__weekday i, kk_std_time_date__weekday j, kk_context_t* _ctx) { /* (i : weekday, j : weekday) -> bool */ 
  kk_std_core_types__order _x_x286 = kk_std_time_date_weekday_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x286, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_clock_fs__lp__lt__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x365 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x365, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_clock_fs__lp__lt__eq__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x366 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x366, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_clock_fs__lp__gt__eq__rp_(kk_std_time_date__clock i, kk_std_time_date__clock j, kk_context_t* _ctx) { /* (i : clock, j : clock) -> bool */ 
  kk_std_core_types__order _x_x367 = kk_std_time_date_clock_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x367, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline kk_string_t kk_std_time_date_show_short(kk_std_time_date__weekday wd, kk_context_t* _ctx) { /* (wd : weekday) -> string */ 
  ...
  kk_std_core_sslice__sslice _x_x368;
  kk_string_t _x_x369 = kk_std_time_date_weekday_fs_show(wd, _ctx); /*string*/
  kk_std_core_types__optional _x_x370 = kk_std_core_types__new_Optional(kk_integer_box(_b_x70_71, _ctx), _ctx); /*? 7*/
  _x_x368 = kk_std_core_sslice_first(_x_x369, _x_x370, _ctx); /*sslice/sslice*/
  return kk_std_core_sslice_string(_x_x368, _ctx);
}
...
static inline bool kk_std_time_date_weekday_fs__lp__lt__rp_(kk_std_time_date__weekday i, kk_std_time_date__weekday j, kk_context_t* _ctx) { /* (i : weekday, j : weekday) -> bool */ 
  kk_std_core_types__order _x_x371 = kk_std_time_date_weekday_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x371, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_time_date_weekday_fs__lp__lt__eq__rp_(kk_std_time_date__weekday i, kk_std_time_date__weekday j, kk_context_t* _ctx) { /* (i : weekday, j : weekday) -> bool */ 
  kk_std_core_types__order _x_x372 = kk_std_time_date_weekday_fs_cmp(i, j, _ctx); /*order*/
  return kk_std_core_order__lp__excl__eq__rp_(_x_x372, kk_std_core_types__new_Gt(_ctx), _ctx);
}
